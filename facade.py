...
class Facade:
    def __init__(self, config):
        ...
        self.__services_facade = ServicesFacade(self.__storage, self.__client)
        ...
        if tenor is not None:
            ...
            if match is not None:
                ...
                if res is None:
                    ...
                    rates = self.__services_facade.rates().get_rates(currency, start, end)
            ...
            return self.__services_facade.rates().get_rates(currency, s_start, s_end)
